...
function TeacherForm() {
  ...
  function handleCreateClass(e: FormEvent) {
    // evita o comportante padrão do form (ao clicar em submit, não redireciona a página)
    e.preventDefault();
    ...
    api
      ...
      .then(() => {
        alert("Cadastro realizado som sucesos!");

        history.push("/"); // redireciona para uma rota
      })
      .catch(() => {
